...
# > IDs.transm
# [1]  5 10 12
# > nrow(data.frame(simpact.trans.net[[12]]))
# [1] 1116
# > nrow(data.frame(simpact.trans.net[[5]]))
# [1] 168
# > nrow(data.frame(simpact.trans.net[[10]]))
# [1] 1000
...
# transmission network 10 (IDs.transm[2])

id.trans <- IDs.transm[2] # 10
...
# We choose  transmission network 10 which is IDs.transm[2]


## Transmission network of seed 10
trans.net <- simpact.trans.net

tra.net.10 <- trans.net[[10]]

tra.net.10$dtimes <- abs(tra.net.10$dtimes-40)+1977
tra.net.10$itimes <- abs(tra.net.10$itimes-40)+1977

min.val = 1977
max.val = round(max(tra.net.10$itimes))
...
dat.f.trans <- as.data.frame(tra.net.10)
...
graph.build <- as.data.frame(trans.net[[10]])
